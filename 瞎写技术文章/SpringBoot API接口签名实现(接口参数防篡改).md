...
# 测试
   ...
   3. 打开 postman 进行POST请求测试，请求Url为 http://localhost:8080/signTest?sign=A0161DC47118062053567CDD10FBACC6 参数为
      ...
      ```
![成功示例图](.SpringBoot API接口签名实现(接口参数防篡改)_images/97755a77.png)
![失败示例图](.SpringBoot API接口签名实现(接口参数防篡改)_images/9a4790ab.png)
# 调用过程
![调用过程](.SpringBoot API接口签名实现(接口参数防篡改)_images/686dc365.png)
